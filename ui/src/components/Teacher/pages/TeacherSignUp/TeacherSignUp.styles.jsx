...
// TeachingAreaContainer will handle the layout for teaching area options
export const TeachingAreaContainer = styled.div`
  display: flex;
...
// TeachingAreaOptionsContainer will style the grid of teaching area checkboxes
export const TeachingAreaOptionsContainer = styled.div`
  display: grid;
